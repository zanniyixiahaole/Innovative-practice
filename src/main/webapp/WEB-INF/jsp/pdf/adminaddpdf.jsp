...
<body>
	...
	<div>
		图书名称： <input type="text" name="fname" id="fname" /> 图书积分： <input
			type="text" name="lname" id="lname"> 图书分配： <input type="text"
			name="phonenumber" id="phonenumber"> <input type="file"
			name="fileName1" id="fileName1" /> <input type="button"
			onclick="sendToUser()" id="sendToUser" value="提交" />
