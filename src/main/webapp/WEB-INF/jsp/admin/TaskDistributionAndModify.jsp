	...
	<div>
		...
		<div style="float: center; width: 90%;">
			...
			<div style="float: center; width: 50%;">
				...
				<div id="choosePage"></div>
				<form action="${pageContext.request.contextPath }/ModifyTask"
					method="get" id="myform">
					图书分配： <input type="text" name="phonenumber" id="phonenumber"
						value=""> <input type="text" name="bookida" id="bookida"
						style="display: none"> <input type="text" name="flagpage"
						id="flagpage" style="display: none" value="${flagPage}"> <input
...
function ajax_submit() {
    ...
    $.ajax({
        ...
        success: function(msg){
        	...
        	$("#phonenumber").val(msg[0].phonenumber);
        	init();
