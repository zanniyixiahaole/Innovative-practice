	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
		<tr>
			<td colspan="2" align="left" valign="top"><span class="time"><strong>上午好！${user.phonenumber}</strong><u>[普通用户]</u></span>
				<div class="top">
					<span class="left">您上次的登灵时间：${user.lastLoginTime}
						登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a
						href="ChangPassword" target="mainFrame" onFocus="this.blur()">更改密码</a>
				</div>
				<div class="sec">
					这是您第<span class="num">${user.loginNum+1}</span>次登录！在所有用户中活跃度位列第<span
						class="num">${rank }</span>名！
				</div></td>
		</tr>
		<tr>
