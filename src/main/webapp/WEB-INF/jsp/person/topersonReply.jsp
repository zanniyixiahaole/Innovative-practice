				...
				<c:forEach items="${ pageInfo.list}" var="list">
					<tr onMouseOut="this.style.backgroundColor='#ffffff'"
						...
						<td align="center" valign="middle" class="borderbottom"><a
							href="${pageContext.request.contextPath }/resourcedetail?resourceId=${list.resourceId }"
							target="_parent" onFocus="this.blur()" class="add">查看</a> <span
							class="gray">&nbsp;|&nbsp;</span> <a
							href="replydelete?replyId=${list.replyId }" target="mainFrame"
